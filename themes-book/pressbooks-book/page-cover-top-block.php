		...
		<section class="top-block clearfix" id="post-<?php the_ID(); ?>" <?php post_class('home-post'); ?>>
			...
			<div class="right-block">
				<a href="http://mobiapp121.com/" class="pressbooks-brand"><img src="<?php bloginfo('template_url'); ?>/images/pressbooks-branding.png" alt="pressbooks-branding" width="186" height="123" /></a>
